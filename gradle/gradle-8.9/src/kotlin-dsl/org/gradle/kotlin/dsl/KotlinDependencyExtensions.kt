...
/**
 * The version of the Kotlin compiler embedded in gradle-kotlin-dsl (currently _1.9.23_).
 */
val embeddedKotlinVersion = "1.9.23"


/**
 * Builds the dependency notation for the named Kotlin [module] at the embedded version (currently _1.9.23_).
 *
...
/**
 * Applies the given Kotlin plugin [module] at the embedded version (currently _1.9.23_).
 *
 ...
 *
 * For example: `plugins { kotlin("jvm") version "1.9.23" }`
 *
 * Visit the [plugin portal](https://plugins.gradle.org/search?term=org.jetbrains.kotlin) to see the list of available plugins.
 *
 * @param module simple name of the Kotlin Gradle plugin module, for example "jvm", "android", "kapt", "plugin.allopen" etc...
 ...
 *
 * Equivalent to `id("org.gradle.kotlin.embedded-kotlin") version "4.4.0"`
 *
...
val PluginDependenciesSpec.`embedded-kotlin`: PluginDependencySpec
    get() = id("org.gradle.kotlin.embedded-kotlin") version "4.4.0"
...
val PluginDependenciesSpec.`kotlin-dsl`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl") version "4.4.0"
...
val PluginDependenciesSpec.`kotlin-dsl-base`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl.base") version "4.4.0"


/**
 * The `kotlin-dsl.precompiled-script-plugins` plugin.
 *
 * Equivalent to `id("org.gradle.kotlin.kotlin-dsl.precompiled-script-plugins") version "4.4.0"`
 *
...
val PluginDependenciesSpec.`kotlin-dsl-precompiled-script-plugins`: PluginDependencySpec
    get() = id("org.gradle.kotlin.kotlin-dsl.precompiled-script-plugins") version "4.4.0"
